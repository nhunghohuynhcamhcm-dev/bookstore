    ...
    <div class="container-fluid bg-dark text-light">
        <div class="row px-xl-5 pt-5">
            <div class="col-lg-4 col-md-12 pr-3 pr-xl-5">
                ...
                <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i> 123 Hồ Chí Minh</p>
            ...
            <div class="col-lg-8 col-md-12 mt-3">
                <div class="row">
                    ...
                    <div class="col-md-4 mt-5">
                        <img src="/public/img/check-footer.png" height="75px" alt="">
                        <div class="row">
                            <img src="/public/img/vnpost1.png" class="col-6" style="width:120px" alt="">
                            <img src="/public/img/ghn.png" class="col-6 p-0" style="width:120px" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row border-top border-light mx-xl-5 py-4">
            <div class="col-md-6 px-xl-0">
                <p class="mb-md-0 text-lg-left">
                    &copy; <a class="font-weight-semi-bold" href="#">Bookworms Store</a>. Dự án ngành Công nghệ thông tin.
                    Thiết kế và cài đặt 
                </p>
            </div>
            <div class="col-md-6 px-xl-0 text-lg-right">
                <img src="/public/img/paymenticon.png" height="30px" alt="">
            </div>
        </div>
    </div>
    <!-- Footer End -->
