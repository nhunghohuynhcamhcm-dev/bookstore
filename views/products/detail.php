                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body p-0">
                            <img width="100%" src="/public/img/product/<?php echo $product->hinh_anh ?>" />
                        </div>
                    </div>
                </div>
            </div>
            <div class="modal fade" id="img-2" tabindex="-1" aria-labelledby="exampleModalLabel">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body p-0">
                            <img width="100%" src="/public/img/product/<?php echo $product->anh_1 ?>" />
                        </div>
                    </div>
                </div>
            </div>
            <div class="modal fade" id="img-3" tabindex="-1" aria-labelledby="exampleModalLabel">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body p-0">
                            <img width="100%" src="/public/img/product/<?php echo $product->anh_2 ?>" />
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-1">
                <div class="row"><button class="btn btn-link p-0" data-bs-toggle="modal" data-bs-target="#img-1"><img width="80%" src="/public/img/product/<?php echo $product->hinh_anh ?>" /></button></div>
                <div class="row"><button class="btn btn-link p-0" data-bs-toggle="modal" data-bs-target="#img-2"><img width="80%" src="/public/img/product/<?php echo $product->anh_1 ?>" /></button></div>
                <div class="row"><button class="btn btn-link p-0" data-bs-toggle="modal" data-bs-target="#img-3"><img width="80%" src="/public/img/product/<?php echo $product->anh_2 ?>" /></button></div>
            </div>
            <div class="col-sm-12 col-md-12 col-lg-4 text-center">
                <img style= "height:300px" src="/public/img/product/<?php echo $product->hinh_anh ?>" />
            </div>
