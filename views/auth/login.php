...
<main>
    <div class="page-header bg-body-login">
        <div class="row align-items-md-stretch">
            <div class="col-md-6">
                <img class="pt-5 ms-5" style="margin-top: 7rem" src="/public/img/login.png" height="450px" alt="">
            </div>
                    ...
                    <?php
                        ...
                        <div class="row justify-content-center">
                            <button class="btn btn-light mb-4 col-3">
                                <img src="/public/img/Googleicon.png" alt="" style="height: 40px;">
                            </button>
                            <button class="btn btn-light mb-4 col-3">
                                <img src="/public/img/facebookicon.png" alt="" style="height: 40px;">
                            </button>
                        </div>
