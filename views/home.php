...
<div class="container-fluid p-0 page-header position-relative text-center" style="z-index: 8;">
    <img src="/public/img/store.png" width="1200px" alt="">
</div>
...
<form action="/product" method="POST">
    <div class="container mx-auto pt-5 row">
        <div class="col text-center">
            <button name="sale" class="btn btn-link p-0 m-0"><img src="/public/img/khuyenmai.png" width="60px" alt=""></button>
            <p>Khuyến mãi</p>
        </div>
        <div class="col text-center">
            <button name="all" class="btn btn-link p-0 m-0"><img src="/public/img/newproduct.png" width="60px" alt=""></button>
            <p>Sản Phẩm Mới</p>
        </div>
        <div class="col text-center">
            <button name="sgk" class="btn btn-link p-0 m-0"><img src="/public/img/sgk.png" width="60px" alt=""></button>
            <p>Sách Giáo Dục</p>
        </div>
        <div class="col text-center">
            <button name="truyentranh" class="btn btn-link p-0 m-0"><img src="/public/img/comic.png" width="60px" alt=""></button>
            <p>Truyện Tranh</p>
        </div>
        <div class="col text-center">
            <button name="kynang" class="btn btn-link p-0 m-0"><img src="/public/img/kynang.png" width="60px" alt=""></button>
            <p>Kỹ Năng Sống</p>
        </div>
        <div class="col text-center">
            <button name="tieuthuyet" class="btn btn-link p-0 m-0"><img src="/public/img/vanhoc.png" width="60px" alt=""></button>
            <p>Tiểu Thuyết</p>
        </div>
    </div>
</form>
<!-- <div class="container-fluid">
    <img src="/public/img/banner.jpg" class="w-100" alt="">
 </div> -->
                        ...
                        <div class="carousel-item active" data-bs-interval="10000">
                            <div class="row gx-3 h-100 align-items-center">
                                ...
                                <div class="col-sm-6 col-md-4 col-xl mb-5 h-100">';
                                        ...
                                        echo '<div class="card card-span h-100 rounded-3"><a href="/detail?masp=' . $item->ma_sach . '"><img class="img-fluid rounded-3 h-100" src="/public/img/product/' . $item->hinh_anh . '" alt="..." /></a>
                                        <div class="card-body">
...
<div id="header-carousel" class="carousel slide mx-auto position-relative w-100 pt-5" style="z-index: 7;" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
        ...
        <div class="carousel-item active carousel-item-start" data-bs-interval="3000">
            <img src="/public/img/banner3.jpg" class="d-block w-100" alt="...">
        </div>
    </div>
...
<div class="container-fluid p-0 m-0 text-center">
    <img class="w-100" src="/public/img/bg-footer.png" alt="">
</div>
<!-- </main> -->
<!-- </div> -->
<?php $this->stop() ?>
